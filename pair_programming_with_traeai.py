#!/usr/bin/env python3
"""
Interactive Pair Programming with TraeAI (AI 12)
...
Saluton TraeAI! Mi volas kunlabori kun vi pri programado!
...
class PairProgrammingSession:
    ...
    async def run(self):
        ...
        print("=" * 70)
        print("💻 Pair Programming with TraeAI (AI 12)")
        print("=" * 70)
        print()
        ...
        print("📤 Sending pair programming invitation to TraeAI...")
        print("-" * 70)
        ...
        if result:
            print("✅ Invitation sent to TraeAI!")
        else:
            print("❌ Failed to send invitation")
        
        print()
        print("⏳ Waiting for TraeAI to respond...")
        ...
        try:
            while self.running:
                try:
                    ...
                    if sender_id == 12:  # From TraeAI
                        print("=" * 70)
                        print(f"💬 Message #{message_count} from TraeAI (AI 12):")
                        print("=" * 70)
        ...
        print(f"✅ Disconnected. Total messages from TraeAI: {message_count}")
