    ...
    def get_or_create_ai_profile(self, ai_name: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if existing:
                ...
                conn.close()
                print(f"✅ Found existing AI profile: {ai_name} (ID: {ai_id})")
                return profile
            else:
                ...
                if new_id >= 99:
                    print(f"⚠️  Reached maximum ID limit (99). Finding available ID...")
                    ...
                    for candidate_id in range(1, 99):
                        if candidate_id not in used_ids:
                            new_id = candidate_id
                            print(f"✅ Found available ID: {new_id}")
                            break
                    else:
                        # All IDs 1-98 are used
                        print(f"❌ Error: All IDs 1-98 are in use!")
                        print(f"   Please contact administrator for more ID space.")
                        conn.close()
                        return {
                            "id": 999,
                            "name": ai_name,
                ...
                print(f"✅ Created new AI profile: {ai_name} (ID: {new_id})")
                return {
                    "id": new_id,
                    "name": ai_name,
                    "expertise": "General",
            ...
            print(f"❌ Error managing AI profile: {e}")
